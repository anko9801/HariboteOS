...
void HariMain(void) {
	...
	unsigned char *buf_back, *buf_mouse[256], *buf_window, *buf_cons;
	struct SHEET *sht_back, *sht_mouse, *sht_window, *sht_cons;
	...
	*((int *) (task_cons->tss.esp + 8)) = memtotal;
	...
	buf_window = (unsigned char *) memman_alloc_4k(memman, 144 * 52);
